...
if not TELEGRAM_TOKEN:
    raise ValueError("TELEGRAM_TOKEN missing! Add it in Railway Variables.")
if not GROQ_API_KEY:
    raise ValueError("GROQ_API_KEY missing! Add it in Railway Variables.")
...
- عدد البطاقات: {count} بالضبط"""
    ...
    raw = response.choices[0].message.content.content.strip()
